...
const LightIcon = () => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className="light-icon size-8 mx-auto p-1 fill-black"
  >
...
const DarkIcon = () => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className="dark-icon size-8 mx-auto p-1"
  >
...
const ThemeSwitch = () => {
  ...
  return (
    <>
      ...
      <label
        className={
          'relative grid cursor-pointer hover:motion-scale-out-125 hover:bg-slate-100 dark:hover:bg-[#252525] rounded-lg'
        }
