...
const Summary = () => {
  return (
    <>
      ...
      <p className="sm:text-2xl md:text-3xl sm:pb-5 md:pb-10 font-light dark:text-slate-400 text-gray-500 motion-opacity-in-0 motion-blur-in motion-translate-y-in-100 motion-delay-[700ms]">
